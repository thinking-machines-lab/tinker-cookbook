...
| **Qwen3.5 dense** (4B, 9B) | ✅ | ✅ | bf16 | Split QKV (`in_proj_q/k/v`); tied embeddings |
| **Qwen3.5 / Qwen3.6 MoE** (35B-A3B, 397B-A17B) | ✅ | ✅ | bf16 | Split QKV + fused experts; vLLM MoE LoRA experimental |
