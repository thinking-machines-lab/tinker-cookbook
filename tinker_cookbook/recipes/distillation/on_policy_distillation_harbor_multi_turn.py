...
class CLIConfig:
    ...
    # sampled tokens, logprobs, one row per turn) for inspection with
    # tinker_cookbook.tokendb. Requires the tokendb extra:
        ...
        if cli_config.token_db_path is not None:
            ...
            writer = stack.enter_context(
                TokenDbWriter(
                    ...
                    context={
                        "recipe_name": "distillation/on_policy_distillation_harbor_multi_turn",
                        "model_name": cli_config.model_name,
                    },
                )
            )
