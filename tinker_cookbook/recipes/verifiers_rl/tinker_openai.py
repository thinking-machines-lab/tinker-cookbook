...
class TinkerChatCompletions(OpenAIAsyncChatCompletions):
    ...
    async def create(self, *args: Any, **kwargs: Any) -> ChatCompletion | AsyncStream[Any]:
        ...
        response.prompt_token_ids = prompt_token_ids  # type: ignore[reportAttributeAccessIssue]
        response.choices[0].token_ids = completion_token_ids  # type: ignore[reportAttributeAccessIssue]
...
class TinkerCompletions(OpenAIAsyncCompletions):
    ...
    async def create(self, *args: Any, **kwargs: Any) -> Completion | AsyncStream[Completion]:
        ...
        response.choices[0].prompt_token_ids = prompt_token_ids  # type: ignore[reportAttributeAccessIssue]
        response.choices[0].token_ids = completion_token_ids  # type: ignore[reportAttributeAccessIssue]
