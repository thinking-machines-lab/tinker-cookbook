"""Integration test for MathDatasetBuilder.

Downloads datasets from HuggingFace Hub (EleutherAI/hendrycks_math, HuggingFaceH4/MATH-500).
This test runs on merge to main, not on every PR, since it depends on external services.
"""
