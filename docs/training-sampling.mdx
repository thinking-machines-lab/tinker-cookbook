...
```
As the name suggests, this model was already fine-tuned for chat/instruction-following. You should check the details of the model you're using in their system cards.
