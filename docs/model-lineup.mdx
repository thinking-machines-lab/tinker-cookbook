...
The Tinker hosted service currently limits context windows to **32k tokens** for all models. This applies even to models with larger native context windows (e.g., Kimi K2 Thinking supports 256k natively).
