...
Rollout sections that end up empty (because the env doesn't use logtree logging) are automatically pruned — you'll only see rollout sections that contain content.
